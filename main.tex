...
% ==========================================
% PORTADA (Idéntica a la imagen de referencia)
% ==========================================
\begin{titlepage}
    \centering
    \vspace*{1cm}
    ...
    \vspace{2cm} % Espacio adicional simulando el logo si está comentado
...
% Forzar que la numeración comience en la siguiente página
\newpage
...
\vspace{0.5cm}
% Espacio para fotografías del laboratorio
\begin{figure}[H]
    \centering
